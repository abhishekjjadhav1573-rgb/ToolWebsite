...
export function Privacy() {
  return (
    <div className="max-w-3xl mx-auto py-8 prose dark:prose-invert">
      ...
      <p>At Smart Utility Hub, we take your privacy seriously. Since our tools operate entirely on your device (client-side), we do not collect, store, or transmit your calculation data or generated assets to any external servers.</p>
...
export function Terms() {
  return (
    <div className="max-w-3xl mx-auto py-8 prose dark:prose-invert">
      ...
      <p>Welcome to Smart Utility Hub. By accessing our website, you agree to these terms.</p>
      <h2>Usage</h2>
...
export function Disclaimer() {
  return (
    <div className="max-w-3xl mx-auto py-8 prose dark:prose-invert">
      ...
      <p>The calculators and utilities available on Smart Utility Hub are for general informational purposes only.</p>
...
export function About() {
  return (
    <div className="max-w-3xl mx-auto py-8 prose dark:prose-invert">
      ...
      <p>Smart Utility Hub was created to consolidate the most commonly used daily calculators and generators into one fast, modern, and beautiful interface.</p>
